<template>
  <div class="bg-sub h-screen flex">
    <div class="w-full border h-full bg-green-100 flex items-center max-[700px]:hidden">
      ...
      <div class="w-[70%] mx-auto">
        ...
        <div class="flex flex-col gap-4 mt-5">
          ...
          <p class="text-main text-base mx-auto">
            No account yet? <a href="#" class="text-blue-500 underline">Sign up here!</a>
          </p>
        </div>
      </div>
    </div>
...
<style scoped>
.social-link {
  @apply flex gap-1 items-center border rounded px-3 py-1 border-light-green;
}
</style>
